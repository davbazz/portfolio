    ...
    >
      ...
      <ul className="mt-[40px] flex flex-col gap-10 md:mt-[80px] md:gap-20 lg:gap-32 2xl:gap-40">
        <li className="relative overflow-hidden rounded-lg px-[24px] py-[30px] md:py-0 lg:px-0">
          ...
          <div>
            <p
              className={`${mono.className} text-[14px] md:text-right md:text-[15px]`}
            >
              Featured Project
            </p>
            ...
            <p className="mt-[30px] text-[16px] md:ml-[40%] md:block md:w-[60%] md:rounded-md md:bg-slate-300 md:py-[20px] md:px-[30px] md:text-right md:text-[17px] lg:ml-[47%] lg:w-[53%] xl:text-[18px]">
            ...
            <div className="mt-[16px] ml-[-8px] mb-[-8px] flex items-center justify-start md:ml-0 md:mr-[-8px] md:justify-end">
              ...
              >
                <svg
                  ...
                  className="feather feather-github h-5 w-5"
                >
                  <title>GitHub</title>
              ...
              >
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="feather feather-external-link h-[21px] w-[22px]"
                >
        ...
        <li className="relative overflow-hidden rounded-lg px-[24px] py-[30px] md:py-0 lg:px-0">
          ...
          <div>
            ...
            <p className="mt-[30px] text-[16px] md:block md:w-[60%] md:rounded-md md:bg-slate-300 md:py-[20px] md:px-[30px] md:text-[17px] lg:w-[53%] xl:text-[18px]">
